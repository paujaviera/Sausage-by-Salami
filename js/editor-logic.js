const FormulaEditor = (() => {
    ...
    function addIngredientRow(parentId, target, defaultName = '', defaultValue = 0.5) {
        ...
        if (!parent) return; // Seguridad por si el ID no existe
    ...
    function setupEditor() {
        ...
        if (recipeId && recipeId !== 'new') {
            ...
            // Cargamos solo Mix Base. 
            // Si la receta es vieja y tiene flavoring, simplemente lo ignorará.
            if (recipe.mixBase) {
    ...
    function saveRecipeFormula() {
        ...
        if (meatRatioInput <= 0 || meatRatioInput > 100) {
            alert("Meat Ratio must be between 1% and 100%.");
            return;
        }
        ...
        const getIngredients = (containerId) => {
            ...
            if (!container) return ingredients;
        ...
        const newRecipe = {
            ...
            // Flavoring eliminado para mayor velocidad y simplicidad
        };
        ...
        // Redirección corregida para evitar el 404
